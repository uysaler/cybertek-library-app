...
public class Login_StepDefinitions {
    ...
    public void i_login_as_a_librarian() {
        String username=ConfigurationReader.getProperty("lib17_user");
        String password=ConfigurationReader.getProperty("lib17_pass");
   ...
   loginPage.signInButton.click();
    ...
    public void iLoginAsAStudent() {
        String username=ConfigurationReader.getProperty("student17_user");
        String password=ConfigurationReader.getProperty("student17_pass");
        loginPage.usernameInput.sendKeys(username);
        loginPage.passwordInput.sendKeys(password);
        loginPage.signInButton.click();
